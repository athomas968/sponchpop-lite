...
class planet_disk_evo:
        ...
        for i, t in enumerate(self.t_range):
            ...
            if self.t_range[i] <= self.t_0*ds.yr:
                ...
                if (self.m < peb_iso) and self.a > (0.03 * ds.auSI):
                    ...
                    # if i % 500 == 0:
                    #     print(f'pebble accretion at time {self.t_range[i]/ds.yr:.2e} with dmdt_peb = {dmdt_peb:.2e} kg/s, m = {self.m:.2e} kg, a = {self.a/ ds.auSI:.2f} au, pebble surface density is {self.pebble_surface_density[bindex]:.2e} kg/m^2 with stokes number {stokes:.2e}')
                ...
                # print(f'dadt = {dadt:.2e} at time {self.t_range[i]/ds.yr:.2e}')
    ...
    def get_other(self):
        return self.ind_peb, self.ind_con, self.ind_mig, self.pebble_surface_density, self.planetesimal_grid
